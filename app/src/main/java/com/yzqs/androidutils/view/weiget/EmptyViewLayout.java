...
public class EmptyViewLayout {
    ...
    private void setDefaultValues() {
        ...
        if (mLoadingView == null) {
            mLoadingView = (ViewGroup) mInflater.inflate(R.layout.layout_loading, null);
        }
...
//		
//		ballAnimation = new RotateAnimation(0, 360, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,0.5f);
//		ballAnimation.setInterpolator(new LinearInterpolator());
//		ballAnimation.setDuration(3000L);
